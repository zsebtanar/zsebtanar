...
class Tag1 {
	...
	function Generate($level) {
		...
		$page[] = '<div class="alert alert-info"><strong>Sorozat $n.$ tagja:</strong><br />Ha egy sorozat első eleme $a_1$, és a differenciája $d$, akkor a sorozat $n.$ tagja a következők képlettel számítható:$$a_n=a_1+(n-1)\cdot d$$</div>';
		$hints[] = $page;
		...
		$page[] = 'Vonjunk ki mindkét oldalból $'.$temp.'$-'.Dativ($temp).'!$$'.$a2.($temp>0 ? '-'.$temp : '-('.$temp.')='.$a2.'+'.abs($temp)).'=a_1$$';
