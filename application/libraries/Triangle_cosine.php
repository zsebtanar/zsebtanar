...
class Triangle_cosine {
	...
	function Generate($level) {
		...
		$hints[][] = 'Rajzoljunk egy derékszögű háromszöget:'.$CI->triangle_tangent->Triangle();
		$hints[][] = 'Tudjuk, hogy az $\textcolor{blue}{'.$node.'}$ befogó $'.$length.'$ cm hosszú:'.$CI->triangle_tangent->Triangle([$node], [$length], ['blue']);
		$hints[][] = 'Tudjuk, hogy az $\textcolor{green}{AB}$ átfogó $'.$AB.'$ cm hosszú:'.$CI->triangle_tangent->Triangle([$node,'AB'], [$length,$AB], ['blue','green']);
