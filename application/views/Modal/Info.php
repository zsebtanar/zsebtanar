	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<h3><b><img class="img_main" src="<?php echo base_url();?>assets/images/shield.png" alt="shield" width="40px">&nbsp;Pajzs</b></h3>
				<ul>
					<li>Ha szintet lépsz egy feladatnál, egy pajzsot kapsz.</li>
				</ul>
				<h3><b><img class="img_main" src="<?php echo base_url();?>assets/images/trophy.png" alt="trophy" width="40px">&nbsp;Trófea</b></h3>
				<ul>
